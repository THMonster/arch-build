...
let PKGNAME = 'gamescope-session-thm'
let OWN_PKGS = [ 'gamescope-session-thm' ]
...
def main [plist: string, print_pkgs: bool] {
	...
	let has_update = check_verion_git 'https://github.com/THMonster/gamescope-session' 'thm' $PKGNAME $plist
	if $has_update {
