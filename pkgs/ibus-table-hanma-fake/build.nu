...
let PKGNAME = 'ibus-table-hanma-fake'
let OWN_PKGS = [ 'ibus-table-hanma-fake' ]
...
def main [plist: string, print_pkgs: bool] {
	...
	let has_update = check_verion_git 'https://github.com/THMonster/projim' 'master' $PKGNAME $plist
	if $has_update {
